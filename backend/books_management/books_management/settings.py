"""Django settings for books_management project."""
...
WSGI_APPLICATION = "books_management.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        "Books Management API. 'debug_information' in error responses"
